...
X = np.column_stack((x1, x2, x3, x4)) # bagımsız degiskenler
print(X)
print(X.shape) 


# hedef degiskenler(x1 ve x2 onemli features, x3 ve x4 onemsiz)
y = (
    4
    + 2.5  * x1
    + 1.8  * x2
...
ax.set_ylabel("x2")
ax.set_zlabel("y")
ax.set_title("4 featureli sentetik veri seti (3D)")
plt.show()
...
"""
Doğrusal: mse: 6.823888208928143  --- R2: 0.9738263277798986
Polynomial: mse: 3.449543221020771  --- R2: 0.9867689489024832
Lasso: mse: 6.964916341571237  --- R2: 0.9732854009644822
Ridge: mse: 6.836142572651731  --- R2: 0.9737793250023696
